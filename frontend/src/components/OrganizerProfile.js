// organizer profile page for managing organization details and discord
...
function OrganizerProfile({ token }) {
  ...
  // load current organizer profile data from server
  ...
  // save updated organization details and optional logo upload
